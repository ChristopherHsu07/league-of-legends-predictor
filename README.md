...
|---|---|---|---|
| T1 vs Team Liquid | T1 | 54.8% | |
| Karmine Corp vs Deep Cross Gaming | Karmine Corp | 54.3% | |

### Upper Bracket Finals

| Matchup | Predicted Winner | Confidence | Actual Result |
|---|---|---|---|
| T1 vs Karmine Corp | T1 | 59.7% | |

### Lower Bracket Semifinals

| Matchup | Predicted Winner | Confidence | Actual Result |
|---|---|---|---|
| Team Liquid vs Deep Cross Gaming | Team Liquid | 59.4% | |
