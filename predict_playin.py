...
lb_finalist, lb_eliminated, conf_5 = predict_game(ub_finalist_loser, lb_winner)
print(f"  >>> {lb_finalist} advances ({conf_5:.1%} confidence), {lb_eliminated} is ELIMINATED")

print("\n--- GRAND FINALS ---")
champion, runner_up, conf_6 = predict_game(ub_finalist, lb_finalist)
print(f"  >>> {champion} wins ({conf_6:.1%} confidence) — ADVANCES TO MAIN EVENT")
print(f"  >>> {runner_up} is ELIMINATED")

print("\n" + "=" * 50)
print("  MAIN EVENT QUALIFIER")
print("=" * 50)
print(f"  {champion}")
print("=" * 50)
